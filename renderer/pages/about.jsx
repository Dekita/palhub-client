        ...
        <div className="container">
            <div className="col-12 col-md-10 offset-0 offset-md-1 col-lg-8 offset-lg-2">
                <div className="mx-auto px-3 py-5">
                    <h1 className="font-bold mb-4">{t('/about.header')}</h1>
                    ...
                    <div className='row'>
                        <div className='col-12 col-xl-6'>
                            <h2 className="font-bold">{t('/about.feature-header')}</h2>
                            <ul className='px-0'>
                                {tA('/about.feature-list').map((feature, idx) => <li key={idx}>{feature}</li>)}
                            </ul>
